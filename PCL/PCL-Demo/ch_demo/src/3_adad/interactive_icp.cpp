...
int main(int argc,char* argv[])
{
    ...
    print4x4Matrix (transformation_matrix);  //展示初始化的转换矩阵  

    // Executing the transformation
    // 利用初始化的转换矩阵获取cloud_icp 
    ...
    *cloud_tr = *cloud_icp;  // We backup cloud_icp into cloud_tr for later use
    ...
    float txt_gray_lvl = 1.0 - bckgr_gray_level;  //字体颜色？
    ...
    // setCameraPosition为9个参数
    // Position:x,y,z
    // lookAt:x,y,z 摄像头朝向，就是看向那里
    // up方向设置，用来设置摄像头的姿态，具体看setCameraPosition.md
    ...
    while (!viewer.wasStopped ())
    {
        ...
        //如果按下space了，这个next_iteration就会变成true，然后开始迭代 
